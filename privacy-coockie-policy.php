...
<body>
    ...
    <span class="load-html" data-container="hero-container" data-source="/partials/hero-coockie.html"></span>
    ...
    <div id="coockie">
        ...
        <hr>
        <h3 id="modalità-e-luogo-del-trattamento-dei-dati-raccolti">Modalità e luogo del trattamento dei Dati raccolti</h3>
        ...
        <h3 id="finalità-del-trattamento-dei-dati-raccolti">Finalità del Trattamento dei Dati raccolti</h3>
        ...
        <hr>
        <h3 id="dettagli-sul-trattamento-dei-dati-personali">Dettagli sul trattamento dei Dati Personali</h3>
        <p>I Dati Personali sono raccolti per le seguenti finalità ed utilizzando i seguenti servizi:</p>
        <h3 id="interazione-con-social-network-e-piattaforme-esterne">Interazione con social network e piattaforme esterne</h3>
        ...
        <h3 id="contenuti-su-piattaforme-esterne">Contenuti su piattaforme esterne</h3>
        ...
        <h3 id="google-analytics-google-ireland-limited">Google Analytics (Google Ireland Limited)</h3>
        <p>Google Analytics è un servizio di analisi web fornito da Google Ireland Limited (“Google”). Google utilizza i Dati Personali raccolti allo scopo di tracciare ed esaminare l’utilizzo di questo Sito, compilare report e condividerli con gli altri servizi sviluppati da Google. Google potrebbe utilizzare i Dati Personali per contestualizzare e personalizzare gli annunci del proprio network pubblicitario. Al seguente link 
        <a target="_blank" href=https://tools.google.com/dlpage/gaoptout?hl&#61;it>Opt Out</a> è inoltre reso disponibile da Google il componente aggiuntivo del browser per la disattivazione di Google Analytics</p>
        <p>Dati personali raccolti: Cookie e Dati di utilizzo. Luogo del trattamento : USA – 
        <a target="_blank" href=https://policies.google.com/privacy?hl&#61;en&amp;gl&#61;it>Privacy Policy</a> – 
        <a target="_blank" href=https://tools.google.com/dlpage/gaoptout?hl&#61;it>Opt Out</a></p>
        <h3 id="diritti-dellutente">Diritti dell’Utente</h3>
        <p>Gli Utenti possono esercitare determinati diritti con riferimento ai Dati trattati dal Titolare.</p>
        <p>In particolare, l’Utente ha il diritto di:</p>
        <ul>
        <li>
        <p>revocare il consenso in ogni momento. L’Utente può revocare il consenso al trattamento dei propri Dati Personali precedentemente espresso.</p>
        </li>
        <li>
        <p>opporsi al trattamento dei propri Dati. L’Utente può opporsi al trattamento dei propri Dati quando esso avviene su una base giuridica diversa dal consenso. Ulteriori dettagli sul diritto di opposizione sono indicati nella sezione sottostante.</p>
        </li>
        <li>
        <p>accedere ai propri Dati. L’Utente ha diritto ad ottenere informazioni sui Dati trattati dal Titolare, su determinati aspetti del trattamento ed a ricevere una copia dei Dati trattati.</p>
        </li>
        <li>
        <p>verificare e chiedere la rettificazione. L’Utente può verificare la correttezza dei propri Dati e richiederne l’aggiornamento o la correzione.</p>
        </li>
        <li>
        <p>ottenere la limitazione del trattamento. Quando ricorrono determinate condizioni, l’Utente può richiedere la limitazione del trattamento dei propri Dati. In tal caso il Titolare non tratterà i Dati per alcun altro scopo se non la loro conservazione.</p>
        </li>
        <li>
        <p>ottenere la cancellazione o rimozione dei propri Dati Personali. Quando ricorrono determinate condizioni, l’Utente può richiedere la cancellazione dei propri Dati da parte del Titolare.</p>
        </li>
        <li>
        <p>ricevere i propri Dati o farli trasferire ad altro titolare. L’Utente ha diritto di ricevere i propri Dati in formato strutturato, di uso comune e leggibile da dispositivo automatico e, ove tecnicamente fattibile, di ottenerne il trasferimento senza ostacoli ad un altro titolare. Questa disposizione è applicabile quando i Dati sono trattati con strumenti automatizzati ed il trattamento è basato sul consenso dell’Utente, su un contratto di cui l’Utente è parte o su misure contrattuali ad esso connesse.</p>
        </li>
        <li>
        <p>proporre reclamo. L’Utente può proporre un reclamo all’autorità di controllo della protezione dei dati personali competente o agire in sede giudiziale.</p>
        </li>
        </ul>
        ...
        <hr>
        <h3 id="ulteriori-informazioni-sul-trattamento">Ulteriori informazioni sul trattamento</h3>
        ...
        <p>Su richiesta dell’Utente, in aggiunta alle informazioni contenute in questa privacy policy, pavesasrl.it potrebbe fornire all’Utente delle informative aggiuntive e contestuali riguardanti Servizi specifici, o la raccolta ed il trattamento di Dati Personali.</p>
        <h3 id="log-di-sistema-e-manutenzione">Log di sistema e manutenzione</h3>
        <p>Per necessità legate al funzionamento ed alla manutenzione, pavesasrl.it e gli eventuali servizi terzi da essa utilizzati potrebbero raccogliere log di sistema, ossia file che registrano le interazioni e che possono contenere anche Dati Personali, quali l’indirizzo IP Utente.</p>
        ...
        <p>pavesasrl.it non supporta le richieste “Do Not Track”. Per scoprire se gli eventuali servizi di terze parti utilizzati le supportino, l’Utente è invitato a consultare le rispettive privacy policy.</p>
        ...
        <h3 id="dati-personali-o-dati">Dati Personali (o Dati)</h3>
        ...
        <p>L’individuo che utilizza pavesasrl.it che, salvo ove diversamente specificato, coincide con l’Interessato.</p>
        ...
        <p>La persona fisica o giuridica, l’autorità pubblica, il servizio o altro organismo che, singolarmente o insieme ad altri, determina le finalità e i mezzi del trattamento di dati personali e gli strumenti adottati, ivi comprese le misure di sicurezza relative al funzionamento ed alla fruizione di pavesasrl.it. Il Titolare del Trattamento, salvo quanto diversamente specificato, è il titolare di pavesasrl.it.</p>
        <h3 id="pavesasrlit-o-questa-applicazione">pavesasrl.it (o questa Applicazione)</h3>
        <p>Lo strumento hardware o software mediante il quale sono raccolti e trattati i Dati Personali degli Utenti.</p>
        <h3 id="servizio">Servizio</h3>
        <p>Il Servizio fornito da pavesasrl.it così come definito nei relativi termini (se presenti) su questo sito/applicazione.</p>
        <h3 id="unione-europea-o-ue">Unione Europea (o UE)</h3>
        <p>Salvo ove diversamente specificato, ogni riferimento all’Unione Europea contenuto in questo documento si intende esteso a tutti gli attuali stati membri dell’Unione Europea e dello Spazio Economico Europeo.</p>
        <h3 id="cookie">Cookie</h3>
        <p>Piccola porzione di dati conservata all’interno del dispositivo dell’Utente.</p>
        <h3 id="riferimenti-legali">Riferimenti legali</h3>
