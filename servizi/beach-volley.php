    ...
    <div class="container">
        <div class="poster2 mt-3" data-aos="fade-up">
            ...
            <div class="poster2__content reveal">
                <h7>Lo sport</h7>
                <p>C'è chi della vita da mare ama la sua dinamicità e la possibilità di svolgere attività sportive non
                    praticabili durante l'inverno.<br> Parliamo di sport all'aperto, come ad esempio il beach volley.
                </p>
                <p>La pallavolo sulla sabbia è molto amata. E' un momento di puro divertimento, con quel pizzico di sana
                    competizione, per tenersi in movimento anche in spiaggia e organizzare entusiasmanti tornei con gli
                    amici.Nel nostro resort potrete trovare una varietà di campi a vostra disposizione per potervi
                    divertire con i vostri amici e passare una giornata alla rassegna del divertimento.</p>
            </div>
        </div>
        ...
        <div class="grid mt-3" data-aos="fade-up">
            ...
            <div class="col reveal">
                <p class="mt-2 mt-sma-0">L’adesione alla nostra TESSERA CLUB offre diversi vantaggi:<br>-Tesseramento
                    A.S.C. (Attività Sportive Confederate)<br>-Affitto campi a 5,00€ l’ora a persona invece che
                    7,00€<br>-10% di sconto su prenotazione di ombrelloni e lettini<br>-Sconto presso la nostra agenzia
                    di riferimento</p>
                <div class="icona">
        ...
        <div class="poster2 mt-3" data-aos="fade-up">
            ...
            <div class="poster2__content reveal">
                <h7>I tornei</h7>
                <p>Organizziamo tornei di beach volley durante tutto il periodo estivo. Con le loro 10 edizioni alle
                    spalle, i nostri circuiti (2×2 maschile e femminile) sono ormai una tradizione.Il circuito prevede
                    la partecipazione di atleti e atlete di ogni livello, con pool e tabelloni diversi per permettere a
                    tutti i beacher di giocare e divertirsi.</p>
                <p>All’ultima tappa Master vengono premiati i vincitori dei due circuiti, maschile e femminile. I
                    migliori si sfidano poi in un ulteriore appuntamento, il King e il Queen of the Beach.</p>
                <p>Oltre ai nostri classici circuiti organizziamo tornei Misti 2×2, ovvero il torneo Misto Giallo (con
                    penalità estratte a sorte e divertenti situazioni inaspettate), il torneo Sotto le Stelle (dove si
                    gioca dalle 18.00 fino all’alba) e altri tornei con formule diverse per varie occasioni.</p>
                <br>
                <div class="icona">
            <span style="color: #57AEE7;">
