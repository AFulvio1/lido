...
<body>
  ...
  <span class="load-html" data-container="hero-container" data-source="/lido/partials/hero-volley.html"></span>
    ...
    <div class="container">
      <div class="poster2 mt-3">
        <div class="poster2__img reveal">
          <img src="/lido/static/img/b-vfoto1.png" alt="">
        </div>
      ...
      <div class="poster2 mt-3">
        <div class="poster2__img reveal">
          <img src="/lido/static/img/b-vfoto2.png" alt="">
        </div>
        <div class="poster2__content reveal">
          <h7>I tornei</h7>
      ...
      <div class="carousel" data-flickity='{ "wrapAround": true }'>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v2.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v3.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v4.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v5.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v6.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v7.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v8.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v9.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v10.png" alt="" />
        </div>
        <div class="carousel-cell">
          <img src="/lido/static/img/b-v1.png" alt="" />
        </div>
      </div>
    </div>
    <br>
