...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="/lido/static/img/favicon.ico" type="image/x-icon">
    <link rel="icon" href="/lido/static/img/favicon.ico" type="image/x-icon">
...
<body>
    ...
    <div class="load-html" data-container="navbar-container" data-source="/lido/partials/navbar-bootstrap.html"></div>

    <!-- HERO -->
    <span id="hero-container"></span>
    <span class="load-html" data-container="hero-container" data-source="/lido/partials/hero-ombrelloni.html"></span>
    ...
    <!-- Buttons -->
    <script type="text/javascript" src="/lido/static/js/buttons.js"></script>
